    ...
    <div className="contact-me">
      ...
      <div className="contact-container">
        <svg
          ...
          onMouseEnter={() => itemHover('contact-me-button-github')}
          onMouseLeave={() => itemExit('contact-me-button-github')}
          fill='gray'
          id="contact-me-button-github"
        >
