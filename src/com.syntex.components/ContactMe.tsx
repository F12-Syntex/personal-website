  ...
  return (
    <div className='contact-me'>
      ...
      <div className="contact-container">
        <svg xmlns="http://www.w3.org/2000/svg" width="min(10vw, 30px)" height="min(5vh, 30px)" fill="gray" viewBox="0 0 16 16" onClick={onGitHubClick} onMouseEnter={itemHover} onMouseLeave={itemExit} className='contact-me-github'>
